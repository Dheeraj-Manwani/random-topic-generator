...
import { Menu, X, Bookmark, Volume2, VolumeX, Music2, Shuffle } from "lucide-react";
...
export default function AppMenu({ view, savedCount, music, sound, disabled, onNavigate, onAudio }: Props) {
  ...
  return <>
    ...
    <dialog id="app-menu" ref={dialog} className="app-menu-modal" aria-labelledby="app-menu-title" onClose={() => {setOpen(false); restoreScroll();}} onClick={event => {
      ...
      <div className="menu-audio"><h3>Audio</h3>
